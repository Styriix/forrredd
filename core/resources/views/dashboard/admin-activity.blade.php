                        ...
                        @foreach($log as $p)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($p->amount_type == 17)
                                        <span class="label bold label-success"><i class="fa fa-shopping-cart"></i> Purchase </span>
                                    @elseif($p->amount_type == 18)
                                        <span class="label bold label-success"><i class="fa fa-suitcase"></i> Trade </span>
                                    @endif

            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="overflow: hidden">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control input-lg bold" name="name" value="{{ $product->name }}" required type="text" placeholder="Product Name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control input-lg bold" name="price" value="{{ $product->price }}" required type="text" placeholder="Product Price ($)" disabled>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input data-toggle="toggle" {{ $product->status == '1' ? 'checked' : '' }} data-onstyle="success"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class="btn btn-primary btn-block btn-lg"><i class="fa fa-send"></i> Update Product</button>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}

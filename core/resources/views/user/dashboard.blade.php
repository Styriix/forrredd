            ...
            <a href="{{ route('user-activity') }}">
                <div class="col-md-3">
                    <div class="dashboard-stat blue">
                        ...
                        <div class="details">
                            <div class="number">
                                {{ $basic->symbol }} <span data-counter="counterup" data-value="{{ round($balance->balance, $basic_setting->deci) }}">{{ round($balance->balance, $basic_setting->deci) }}</span>
                            </div>
            ...
            <a href="{{ route('user-repeat-history') }}">
                <div class="col-md-3">
                    <div class="dashboard-stat purple">
                        ...
                        <div class="details">
                            <div class="number">
                                {{ $basic->symbol }}  <span data-counter="counterup" data-value="{{ $trade }}">{{ $trade }}</span>
                            </div>
                            <div class="desc bold"> Total Trade </div>
                        </div>
                    </div>
                </div>
            </a>

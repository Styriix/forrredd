    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item">
                    <a href="{!! route('manage-product-category') !!}" class="nav-link nav-toggle"><i class="fa fa-tags"></i>
                        <span class="title">Product Category</span></a>
                </li>

                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle"><i class="fa fa-list"></i>
                        <span class="title">Products</span><span class="arrow"></span></a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="{!! route('product-create') !!}" class="nav-link nav-toggle"><i class="fa fa-plus"></i>
                                <span class="title">Add Product</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('products') !!}" class="nav-link nav-toggle"><i class="fa fa-desktop"></i>
                                <span class="title">View all Product</span></a>
                        </li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle"><i class="fa fa-suitcase"></i>
                        <span class="title">Trades</span><span class="arrow"></span></a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="{!! route('current-trades') !!}" class="nav-link nav-toggle"><i class="fa fa-clock-o"></i>
                                <span class="title">Current Trades</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('product-trades-history') !!}" class="nav-link nav-toggle"><i class="fa fa-desktop"></i>
                                <span class="title">Trade History</span></a>
                        </li>
                    </ul>
                </li>

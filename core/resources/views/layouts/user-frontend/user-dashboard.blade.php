            ...
            <div class="row">
                ...
                <div class="col-md-10 text-right">
                    <ul id="menu-bar">
                        ...
                        <li><a href="#">Trades <i class="fa fa-caret-down"></i></a>
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{!! route('buy-product') !!}" class="nav-link ">
                                        <span class="title">Buy Product</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{!! route('user-purchase-history') !!}" class="nav-link ">
                                        <span class="title">Purchase History</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{!! route('user-trade-history') !!}" class="nav-link ">
